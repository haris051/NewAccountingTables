...
insert into 
			Stock_accounting
								select 
										...
										null as Form_Detail_Id					,
										'StockTransfer' as Form_Flag			,
										case when A.FREIGHT_CHARGES<0 then 57 else 150 end as GL_FLAG	,
...
insert into Payments_Accounting(
						...
						select PS_ID,
							   ...
							   case when Amount<0 then 510 else GL_FLAG END as GL_FLAG,
							   ABS(Amount) as Amount,
							   GL_ACC_ID,
							   FORM_DATE,
							   FORM_REFERENCE,
...
insert into Payments_Accounting(
						...
						select PS_ID,
							   PS_DETAIL_ID,
							   'PaymentSent' as 'Form_Flag',
							   case when Amount < 0 then 511 else GL_FLAG end as GL_FLAG,
							   ABS(Amount) as Amount,
							   GL_ACC_ID,
							   FORM_DATE,
							   FORM_REFERENCE,
